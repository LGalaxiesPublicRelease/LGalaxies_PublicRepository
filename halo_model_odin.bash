...
#mpiexec -perhost 2 -np 64 ./L-Galaxies ./input/input_MR_W1_PLANCK.par > prog01.out 
mpiexec -perhost 2 -np 64 ./L-Galaxies ./input/input_mcmc_halomodel_guo11_MR_W1_W1.par > prog01.out 
