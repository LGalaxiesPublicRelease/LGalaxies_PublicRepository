...
void add_galaxies_together(int t, int p)
{
  ...
  //PRINT
 	/* 	if(HaloIDs[Gal[t].HaloNr].HaloID < 5000035000046 && (Gal[t].Type == 0 || Gal[t].Type == 1))
       	   printf("new lum=%0.10e lumcentral=%0.10e lum=sat%0.10e t=%d p=%d\n" ,Gal[t].Lum[0][49]+Gal[p].Lum[0][49],
       	  		 Gal[t].Lum[0][49],Gal[p].Lum[0][49],t,p);*/
