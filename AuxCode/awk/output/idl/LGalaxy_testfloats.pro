...
; assumes the existence of a function testFloat accepting an array of floats
 ...
 sel = testFloat(LGs.ReheatedGas)
 if(sel(0) gt -1) then begin
     bad=1
     print, 'ReheatedGas --- ', nstart+sel
     print, 'ReheatedGas --- ', LGs[sel].ReheatedGas
     badranges=[badranges,sel]
 endif
 ...
 sel = testFloat(LGs.MetalsReheatedGas)
 if(sel(0) gt -1) then begin
     bad=1
     print, 'MetalsReheatedGas --- ', nstart+sel
     print, 'MetalsReheatedGas --- ', LGs[sel].MetalsReheatedGas
     badranges=[badranges,sel]
 endif
