...
metadata_db:
	awk -f ./AuxCode/awk/extract_struct_metals.awk ./code/allvars.i > ./awk/structs.dat
	awk -f ./AuxCode/awk/extract_struct_elements.awk ./code/allvars.i >> ./awk/structs.dat
	awk -f ./AuxCode/awk/extract_struct_GALAXY_OUTPUT.awk ./code/allvars.i >> ./awk/structs.dat
